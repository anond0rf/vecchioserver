...
<h3 align="center">VecchioServer</h3>
  <p align="center">
    <strong>VecchioServer</strong> is a RESTful server designed for posting on <a href="https://vecchiochan.com/">vecchiochan.com</a>
    <br />
    <br />
...
VecchioServer wraps around [vecchioclient](https://github.com/anond0rf/vecchioclient) by exposing an API that follows the OpenAPI specification and includes a Swagger UI for easy testing and documentation.  
...
2. **Optional**: if you intend to modify the `api/openapi.yaml` file, you need to install  [oapi-codegen](https://github.com/oapi-codegen/oapi-codegen) and run the following command to regenerate the OpenAPI types, server and specification:
